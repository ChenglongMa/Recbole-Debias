...
class DIS(SequentialRecommender):
    """DIS has an interest extractor layer to capture temporal interests from history behavior sequence,and an
    ...
    def __init__(self, config, dataset):
        super(DIS, self).__init__(config, dataset)
...
class InterestExtractorNetwork(nn.Module):
    ...
    user takes one behavior. At the interest extractor layer, DIS extracts series of interest states from
